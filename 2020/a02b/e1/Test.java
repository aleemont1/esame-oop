 ...
 * modella
 * una factory per PatternExtractor, che a sua volta modella un trasformatore da
 * liste a
 * liste, che funziona isolando nell'input pezzi di lista i cui valori hanno
 * certe caratteristiche
 * e producendo conseguentemente una informazione riassuntiva in uscita per
